...
class SettingsViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        favoritesViewModel.bindallProductsListToController = {[weak self] in
            ...
            for product in list {
                lineItems.append(LineItems(productId: product.id , price: product.price, quantity: 1 , title: product.title, properties: [Properties(name: "image_url", value: product.image )],vendor: nil, grams: 0))
            }
